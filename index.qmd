...
## Neurocognitive Examination {background-color="var(--black)"  background-repeat="repeat"}
...
## Behavioral/Emotional/Personality {background-color="var(--black)"  background-repeat="repeat"}
...
## Effort/Validity Testing {background-color="var(--black)"  background-repeat="repeat"}
