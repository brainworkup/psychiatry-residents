...
## Neurocognitive Examination {background-color="var(--near-black)"  background-repeat="repeat"}
...
## Behavioral/Emotional/Personality {background-color="var(--near-black)"  background-repeat="repeat"}
...
## Effort/Validity Testing {background-color="var(--near-black)"  background-repeat="repeat"}
